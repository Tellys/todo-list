            ...
            <section>
                <div class="container py-5 h-100">
                    <div class="row d-flex align-items-center justify-content-center h-100">
                        ...
                        <p class="text-center"><router-link :to="{ name: 'userEdit', params: { id: items.id } }"
...
export default {
    ...
    methods: {
        async getItens() {
            // é necessario o refresh para atualizar o cache com novos dados se for o caso
            await Api.refresToken();
