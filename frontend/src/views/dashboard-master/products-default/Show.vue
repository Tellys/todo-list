            ...
            <section>
                <div class="container py-5 h-100">
                    <div class="row d-flex align-items-center justify-content-center h-100">
                        ...
                        <p class="text-center"><router-link :to="{ name: 'dashboardMasterProductDefaultEdit', params: { id: items.id } }"
...
export default {    name: 'dashboardMasterProductDefaultShow',
    components: {
    ...
    methods: {
        async getItens() {
            const response = await Api.get('products-default/' + this.id);
