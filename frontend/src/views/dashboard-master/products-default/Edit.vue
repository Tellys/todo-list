            ...
            <section>
                <div class="container py-5 h-100">
                    <div class="row d-flex align-items-center justify-content-center h-100">
                        <DynamicForm :myUri="myUri" myFormMethod="put" :routeNameSuccessRedirect="{name:'dashboardMasterProductDefaultList'}"></DynamicForm>
                    </div>
                </div>
            </section>
        </template>
...
components: {
    ...
    data() {
        return {
            myUri: 'products-default/' + this.$route.params.id + '/edit'
        }
    },
    methods:{
        testAlert(){
