    ...
    <templateView>
        ...
        <template v-slot:slotTitlePage>
            <div class="p-2" style="background-color: silver;">
                ...
                <h1>Editar Políticas de Desconto</h1>
                <p>Modifique os dados em nossa base de dados</p>
            </div>
        </template>
            ...
            <section>
                <div class="container py-5 h-100">
                    <div class="row d-flex align-items-center justify-content-center h-100">
                        <DynamicForm :myUri="myUri" myFormMethod="put" :routeNameSuccessRedirect="{name:'dashboardMasterDiscountPolicyList'}"></DynamicForm>
                    </div>
                </div>
            </section>
        </template>
...
components: {
    ...
    data() {
        return {
            myUri: 'discount-policy/' + this.$route.params.id + '/edit'
        }
    },
    methods:{
        testAlert(){
